...
@scenario(
    SET_FEATURE,
    "Check if the character ( belongs to the compliment of the set of digits",
)
...
@scenario(
    CHAR_FEATURE,
    "Check if the Char scan matches a single arbitrary character 1",
)
...
@scenario(
    CHAR_FEATURE,
    "Check if the Char scan matches a single arbitrary character [",
)
...
@scenario(
    CHAR_FEATURE,
    "Check if the Char scan matching P matches a single specific character P",
)
...
@scenario(
    CHAR_FEATURE,
    "Check if the Char scan matching P matches a single specific character Q",
)
